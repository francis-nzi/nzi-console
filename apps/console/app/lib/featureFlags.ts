...
export type DataEntryAdapter = "spend" | "spend-import" | "portal-spend" | "client-factors" | "commuting" | "vehicle" | "manual" | "import" | "data-entry-accordion" | "job-stage-sections" | "entry-lean-capture" | "data-assurance" | "data-entry-fast-add";

  ...
  return <ScreenState result={result}>{() => (
    <AppShell rail={rail}>
      ...
      <div className="nz-body">
        <section className="nz-chart-hero"><div><span className="nz-eyebrow light">Reviewed snapshot · J000712</span><h2>From calculation lineage to publication-ready insight.</h2><p>Every visual is derived from reviewed data, carries its evidence identity, and renders consistently across every delivery surface.</p></div><div className="nz-chart-flow"><span><b>01</b>Reviewed data</span><i>→</i><span><b>02</b>Manifest gate</span><i>→</i><span><b>03</b>Every surface</span></div></section>

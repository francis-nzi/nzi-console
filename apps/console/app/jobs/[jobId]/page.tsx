...
import type { DatasetOption,EmissionsTargetReadModel,FactorOption,IntensityTargetReadModel,SiteOption,ScopeQaReadiness,ScopeRowReadModel } from "@nzi/contracts";
...
export default async function JobPage({ params }: { params: Promise<{ jobId: string }> }) {
  ...
  const [result, scopeRows, factors,target,intensity,sites] = await Promise.all([

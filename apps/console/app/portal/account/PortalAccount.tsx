...
export function PortalAccount() {
  ...
  return <main className="nz-account-shell">
    <header className="nz-account-header"><a href="/portal" className="nz-portal-brand"><span>N</span><div><b>NZ Insights Pro</b><small>Client portal</small></div></a><a href="/portal" className="nz-btn">Back to reporting jobs</a></header>

...
export type ReviewedCrpSnapshotReadModel={id:string;jobId:string;jobNumber:string;client:string;reportingYear:number;version:number;jobVersion:number;createdAt:string;createdBy:string;dataHash:string;measurements:Array<{rowId:string;rowVersion:number;scope:"1"|"2"|"3";sourceLabel:string;tco2e:number;factorSet:string;qualityTier:ScopeQualityTier;reviewedBy:string}>};

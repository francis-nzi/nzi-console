...
export type ScopeRowWriteFields = { scope: string; sourceLabel: string; siteId?:string|null;siteLabel?:string|null;quantity: number | null; unit: string | null; datasetId: string | null; factorId: string | null; factorVersion: string | null; factorLabel: string | null; qualityTier: ScopeQualityTier | null };
...
export type ReviewedCrpSnapshotReadModel={id:string;jobId:string;jobNumber:string;client:string;reportingYear:number;version:number;jobVersion:number;createdAt:string;createdBy:string;dataHash:string;target:EmissionsTargetReadModel|null;annualComparison:AnnualScopeComparison[];measurements:Array<{rowId:string;rowVersion:number;scope:"1"|"2"|"3";sourceLabel:string;siteId?:string|null;siteLabel?:string|null;tco2e:number;factorSet:string;qualityTier:ScopeQualityTier;reviewedBy:string}>};

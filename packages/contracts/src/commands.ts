...
export type ScopeRowWriteFields = { scope: string; sourceLabel: string; reportLabel?:string|null; notes?:string|null; monthlyActivity?:MonthlyActivitySlot[]; siteId?:string|null;siteLabel?:string|null;purchasedGoodsCategoryId?:string|null;purchasedGoodsCategoryLabel?:string|null;quantity: number | null; unit: string | null; datasetId: string | null; factorId: string | null; factorVersion: string | null; factorLabel: string | null; qualityTier: ScopeQualityTier | null; overrideTco2e?: number | null; overrideReason?: string | null };

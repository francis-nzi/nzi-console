...
const context = { organisationId: "org-nzi", actorId: "user-1", principal: "staff" as const, grant: commandGrantForRole("admin", "org-nzi", "user-1"), idempotencyKey: "idem-1", correlationId: "corr-1" };

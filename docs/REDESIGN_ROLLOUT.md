...
| B5 | Portal spend mirror (paste + manual; CSV upload → B5.1) | NZC-016/035/036 | `portal-spend` | `ACCEPTANCE_B5_PORTAL_SPEND.md` · `STAGING_ACCEPTANCE_B5.md` | B2, portal framework | 🟡 increment 1 (schema `0042` + backend) built; surface + flip pending |

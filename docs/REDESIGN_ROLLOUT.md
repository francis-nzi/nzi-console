...
| S1 | Source register: group roll-up + commuting/vehicle bulk + Company Vehicles framing (register itself already built, unflagged) | NZC-043/037/036 | `commuting`,`vehicle` | `ACCEPTANCE_S1_SOURCE_REGISTER.md` (draft) | migrations 0036/0037 (on `main`) | 🟡 gate drafted for Francis (5 open questions) — **largest** |

...
| S1 | Source register group roll-up + commuting/vehicle framing (register itself already built) | NZC-043/037/036 | `commuting`,`vehicle` | `ACCEPTANCE_S1_SOURCE_REGISTER.md` · `STAGING_ACCEPTANCE_S1.md` | migrations 0036/0037/0043 | 🟢 built: model + flagged register UI + **S1.1 commuting bulk paste**; S1.2 (vehicle bulk) + per-domain flips pending — **largest** |

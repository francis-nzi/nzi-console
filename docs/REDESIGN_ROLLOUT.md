...
| R5a | Audit appendices (Full Emissions Audit + by Site/Scope/Category) + repeating-header/row-atomic print CSS | `report-paged` | 🟢 built; `docs/ACCEPTANCE_R5_PAGED_OUTPUT.md` |

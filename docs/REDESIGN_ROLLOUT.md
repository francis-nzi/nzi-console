...
| R5b | On-screen Continuous / Page-view · A4 toggle, running header/footer, page-break markers — **Paged.js**, confirmed by Francis 4 Sep 2026 | `report-paged` | 🟢 built; `docs/ACCEPTANCE_R5_PAGED_OUTPUT.md`; human check (Page view vs. actual PDF) pending before flip |
